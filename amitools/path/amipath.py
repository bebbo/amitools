...
class AmiPath(object):
    ...
    def parent(self):
        ...
        If no parent exists then None is returned.

        The parent relative to the given path is returned
    ...
    def volpath(self):
        ...
        volume path for this path. For a multi path None is returned!
        """
        paths = self.volpaths
        if len(paths) == 1:
            return paths[0]
    ...
    def volpaths(self):
        ...
        are generated by recursevily applying mutli-assigns.
        """
        pass
